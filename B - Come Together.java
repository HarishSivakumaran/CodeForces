...
public class Main {
    ...
    public static void solve(){
       ...
       long modXb = (long)b[0]-a[0];
       long modYb = (long)b[1]-a[1];
       long modXc = (long)c[0]-a[0];
       long modYc = (long)c[1]-a[1];
       
       long ans = 1;
       if(modXb*modXc >= 0){
           ans += (Math.min(Math.abs(modXb), Math.abs(modXc)));
       }
       
       if(modYb*modYc >= 0){
           ans += (Math.min(Math.abs(modYb), Math.abs(modYc)));
       }
